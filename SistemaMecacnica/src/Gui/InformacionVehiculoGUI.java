                                ...
                                lblCombustible.setFont(new Font("Roboto", Font.PLAIN, 13));
                                        ...
                                        lblCilindrada.setFont(new Font("Roboto", Font.PLAIN, 13));
                                                ...
                                                panel.add(label_7);
                                                        ...
                                                        panel.add(lblColor);
                                                        lblColor.setFont(new Font("Roboto", Font.PLAIN, 13));
                                                        JLabel label_6 = new JLabel(color);
                                                        label_6.setFont(new Font("Roboto", Font.PLAIN, 13));
                                                        label_6.setBounds(112, 26, 117, 12);
                                                        panel.add(label_6);
                                                ...
                                                lblPlaca.setFont(new Font("Roboto", Font.PLAIN, 13));
                                                                        ...
                                                                        lblChasis.setFont(new Font("Roboto", Font.PLAIN, 13));
                                                                                ...
                                                                                lblMotor.setFont(new Font("Roboto", Font.PLAIN, 13));
                                                                                        ...
                                                                                        lblVin.setFont(new Font("Roboto", Font.PLAIN, 13));
                                                                                                ...
                                                                                                lblNewLabel.setBounds(108, 11, 269, 23);
